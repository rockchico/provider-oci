...
// GetInitParameters of this SteeringPolicyAttachment
func (tr *SteeringPolicyAttachment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SteeringPolicyAttachment
func (tr *SteeringPolicyAttachment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
