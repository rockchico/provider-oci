...
// GetInitParameters of this TsigKey
func (tr *TsigKey) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TsigKey
func (tr *TsigKey) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
