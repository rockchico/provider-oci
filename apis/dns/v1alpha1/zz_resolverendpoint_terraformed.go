...
// GetInitParameters of this ResolverEndpoint
func (tr *ResolverEndpoint) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ResolverEndpoint
func (tr *ResolverEndpoint) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
