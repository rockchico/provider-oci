...
// GetInitParameters of this SteeringPolicy
func (tr *SteeringPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SteeringPolicy
func (tr *SteeringPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
