...
type ChecksHTTPMonitorInitParameters struct {
...
type ChecksHTTPMonitorObservation struct {
...
type ChecksHTTPMonitorParameters struct {
...
// ChecksHTTPMonitorSpec defines the desired state of ChecksHTTPMonitor
type ChecksHTTPMonitorSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ChecksHTTPMonitorParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ChecksHTTPMonitorInitParameters `json:"initProvider,omitempty"`
}

// ChecksHTTPMonitorStatus defines the observed state of ChecksHTTPMonitor.
type ChecksHTTPMonitorStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ChecksHTTPMonitorObservation `json:"atProvider,omitempty"`
}
...
// ChecksHTTPMonitor is the Schema for the ChecksHTTPMonitors API. Provides the Http Monitor resource in Oracle Cloud Infrastructure Health Checks service
...
type ChecksHTTPMonitor struct {
	...
	Spec   ChecksHTTPMonitorSpec   `json:"spec"`
	Status ChecksHTTPMonitorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ChecksHTTPMonitorList contains a list of ChecksHTTPMonitors
type ChecksHTTPMonitorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ChecksHTTPMonitor `json:"items"`
}

// Repository type metadata.
var (
	ChecksHTTPMonitor_Kind             = "ChecksHTTPMonitor"
	ChecksHTTPMonitor_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ChecksHTTPMonitor_Kind}.String()
	ChecksHTTPMonitor_KindAPIVersion   = ChecksHTTPMonitor_Kind + "." + CRDGroupVersion.String()
	ChecksHTTPMonitor_GroupVersionKind = CRDGroupVersion.WithKind(ChecksHTTPMonitor_Kind)
)

func init() {
	SchemeBuilder.Register(&ChecksHTTPMonitor{}, &ChecksHTTPMonitorList{})
}
