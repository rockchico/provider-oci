...
type BalancerRuleSetInitParameters struct {
...
type BalancerRuleSetSpec struct {
	...
	// autoscaler.
	InitProvider BalancerRuleSetInitParameters `json:"initProvider,omitempty"`
}
...
// BalancerRuleSet is the Schema for the BalancerRuleSets API. Provides the Rule Set resource in Oracle Cloud Infrastructure Load Balancer service
