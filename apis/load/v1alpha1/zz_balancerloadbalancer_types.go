...
type BalancerLoadBalancerInitParameters struct {
...
type BalancerLoadBalancerSpec struct {
	...
	// autoscaler.
	InitProvider BalancerLoadBalancerInitParameters `json:"initProvider,omitempty"`
}
...
// BalancerLoadBalancer is the Schema for the BalancerLoadBalancers API. Provides the Load Balancer resource in Oracle Cloud Infrastructure Load Balancer service
