...
// GetInitParameters of this BalancerBackendSet
func (tr *BalancerBackendSet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerBackendSet
func (tr *BalancerBackendSet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
