...
// GetInitParameters of this BalancerPathRouteSet
func (tr *BalancerPathRouteSet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerPathRouteSet
func (tr *BalancerPathRouteSet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
