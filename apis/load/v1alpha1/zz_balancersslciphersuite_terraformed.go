...
// GetInitParameters of this BalancerSSLCipherSuite
func (tr *BalancerSSLCipherSuite) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerSSLCipherSuite
func (tr *BalancerSSLCipherSuite) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
