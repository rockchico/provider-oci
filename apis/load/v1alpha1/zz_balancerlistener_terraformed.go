...
// GetInitParameters of this BalancerListener
func (tr *BalancerListener) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerListener
func (tr *BalancerListener) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
