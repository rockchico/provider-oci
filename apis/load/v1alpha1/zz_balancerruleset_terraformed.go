...
// GetInitParameters of this BalancerRuleSet
func (tr *BalancerRuleSet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerRuleSet
func (tr *BalancerRuleSet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
