...
// GetInitParameters of this BalancerLoadBalancer
func (tr *BalancerLoadBalancer) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerLoadBalancer
func (tr *BalancerLoadBalancer) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
