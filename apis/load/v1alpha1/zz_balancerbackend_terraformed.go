...
// GetInitParameters of this BalancerBackend
func (tr *BalancerBackend) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerBackend
func (tr *BalancerBackend) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
