...
// GetInitParameters of this BalancerLoadBalancerRoutingPolicy
func (tr *BalancerLoadBalancerRoutingPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerLoadBalancerRoutingPolicy
func (tr *BalancerLoadBalancerRoutingPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
