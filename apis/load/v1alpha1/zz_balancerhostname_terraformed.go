...
// GetInitParameters of this BalancerHostname
func (tr *BalancerHostname) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerHostname
func (tr *BalancerHostname) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
