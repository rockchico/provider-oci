...
func (tr *BalancerCertificate) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"passphrase": "passphraseSecretRef", "private_key": "privateKeySecretRef"}
}
...
// GetInitParameters of this BalancerCertificate
func (tr *BalancerCertificate) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BalancerCertificate
func (tr *BalancerCertificate) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
