...
// GetInitParameters of this LoadBalancerListener
func (tr *LoadBalancerListener) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LoadBalancerListener
func (tr *LoadBalancerListener) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
