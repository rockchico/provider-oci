...
// GetInitParameters of this LoadBalancerNetworkLoadBalancersBackendSetsUnified
func (tr *LoadBalancerNetworkLoadBalancersBackendSetsUnified) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LoadBalancerNetworkLoadBalancersBackendSetsUnified
func (tr *LoadBalancerNetworkLoadBalancersBackendSetsUnified) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
