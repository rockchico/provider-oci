...
// GetInitParameters of this LoadBalancerNetworkLoadBalancer
func (tr *LoadBalancerNetworkLoadBalancer) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LoadBalancerNetworkLoadBalancer
func (tr *LoadBalancerNetworkLoadBalancer) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
