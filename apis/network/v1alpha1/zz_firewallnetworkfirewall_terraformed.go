...
// GetInitParameters of this FirewallNetworkFirewall
func (tr *FirewallNetworkFirewall) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this FirewallNetworkFirewall
func (tr *FirewallNetworkFirewall) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
