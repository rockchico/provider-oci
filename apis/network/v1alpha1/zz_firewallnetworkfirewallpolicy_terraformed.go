...
// GetInitParameters of this FirewallNetworkFirewallPolicy
func (tr *FirewallNetworkFirewallPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this FirewallNetworkFirewallPolicy
func (tr *FirewallNetworkFirewallPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
