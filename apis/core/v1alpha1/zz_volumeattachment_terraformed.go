...
// GetInitParameters of this VolumeAttachment
func (tr *VolumeAttachment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VolumeAttachment
func (tr *VolumeAttachment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
