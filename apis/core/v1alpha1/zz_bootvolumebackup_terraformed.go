...
// GetInitParameters of this BootVolumeBackup
func (tr *BootVolumeBackup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BootVolumeBackup
func (tr *BootVolumeBackup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
