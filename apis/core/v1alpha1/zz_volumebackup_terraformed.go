...
// GetInitParameters of this VolumeBackup
func (tr *VolumeBackup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VolumeBackup
func (tr *VolumeBackup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
