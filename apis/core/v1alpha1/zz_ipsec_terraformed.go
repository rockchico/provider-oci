...
// GetInitParameters of this Ipsec
func (tr *Ipsec) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Ipsec
func (tr *Ipsec) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
