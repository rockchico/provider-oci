...
// GetInitParameters of this ShapeManagement
func (tr *ShapeManagement) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ShapeManagement
func (tr *ShapeManagement) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
