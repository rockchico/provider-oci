...
// GetInitParameters of this IPv6
func (tr *IPv6) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IPv6
func (tr *IPv6) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
