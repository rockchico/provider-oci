...
// GetInitParameters of this PrivateIP
func (tr *PrivateIP) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PrivateIP
func (tr *PrivateIP) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
