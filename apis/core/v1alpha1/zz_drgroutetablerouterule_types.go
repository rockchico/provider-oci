...
type DrgRouteTableRouteRule struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.drgRouteTableId) || (has(self.initProvider) && has(self.initProvider.drgRouteTableId))",message="spec.forProvider.drgRouteTableId is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.nextHopDrgAttachmentId) || (has(self.initProvider) && has(self.initProvider.nextHopDrgAttachmentId))",message="spec.forProvider.nextHopDrgAttachmentId is a required parameter"
