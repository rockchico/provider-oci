...
// GetInitParameters of this NetworkSecurityGroupSecurityRule
func (tr *NetworkSecurityGroupSecurityRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkSecurityGroupSecurityRule
func (tr *NetworkSecurityGroupSecurityRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
