...
// GetInitParameters of this Cpe
func (tr *Cpe) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Cpe
func (tr *Cpe) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
