...
// GetInitParameters of this ComputeCapacityReservation
func (tr *ComputeCapacityReservation) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ComputeCapacityReservation
func (tr *ComputeCapacityReservation) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
