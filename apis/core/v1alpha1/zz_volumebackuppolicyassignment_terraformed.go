...
// GetInitParameters of this VolumeBackupPolicyAssignment
func (tr *VolumeBackupPolicyAssignment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VolumeBackupPolicyAssignment
func (tr *VolumeBackupPolicyAssignment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
