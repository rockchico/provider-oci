...
// GetInitParameters of this NetworkSecurityGroup
func (tr *NetworkSecurityGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NetworkSecurityGroup
func (tr *NetworkSecurityGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
