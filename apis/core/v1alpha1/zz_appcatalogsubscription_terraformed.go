...
// GetInitParameters of this AppCatalogSubscription
func (tr *AppCatalogSubscription) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this AppCatalogSubscription
func (tr *AppCatalogSubscription) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
