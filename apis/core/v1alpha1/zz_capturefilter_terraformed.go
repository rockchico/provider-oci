...
// GetInitParameters of this CaptureFilter
func (tr *CaptureFilter) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CaptureFilter
func (tr *CaptureFilter) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
