...
// GetInitParameters of this VolumeGroupBackup
func (tr *VolumeGroupBackup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VolumeGroupBackup
func (tr *VolumeGroupBackup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
