...
// GetInitParameters of this VolumeBackupPolicy
func (tr *VolumeBackupPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VolumeBackupPolicy
func (tr *VolumeBackupPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
