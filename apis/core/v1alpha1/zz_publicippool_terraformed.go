...
// GetInitParameters of this PublicIPPool
func (tr *PublicIPPool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PublicIPPool
func (tr *PublicIPPool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
