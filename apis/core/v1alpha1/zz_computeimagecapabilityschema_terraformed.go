...
// GetInitParameters of this ComputeImageCapabilitySchema
func (tr *ComputeImageCapabilitySchema) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ComputeImageCapabilitySchema
func (tr *ComputeImageCapabilitySchema) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
