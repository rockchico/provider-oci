...
// GetInitParameters of this LocalPeeringGateway
func (tr *LocalPeeringGateway) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LocalPeeringGateway
func (tr *LocalPeeringGateway) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
