...
// GetInitParameters of this CrossConnectGroup
func (tr *CrossConnectGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this CrossConnectGroup
func (tr *CrossConnectGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
