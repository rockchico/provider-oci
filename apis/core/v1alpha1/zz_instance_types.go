...
type InstanceInitParameters struct {
	...
	// (Updatable)
	SourceDetails []InstanceSourceDetailsInitParameters `json:"sourceDetails,omitempty" tf:"source_details,omitempty"`
...
type InstanceObservation struct {
	...
	// (Updatable)
	SourceDetails []InstanceSourceDetailsObservation `json:"sourceDetails,omitempty" tf:"source_details,omitempty"`
...
type InstanceSourceDetailsInitParameters struct {
