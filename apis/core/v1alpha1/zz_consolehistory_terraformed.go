...
// GetInitParameters of this ConsoleHistory
func (tr *ConsoleHistory) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ConsoleHistory
func (tr *ConsoleHistory) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
