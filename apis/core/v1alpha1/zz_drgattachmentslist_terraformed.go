...
// GetInitParameters of this DrgAttachmentsList
func (tr *DrgAttachmentsList) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DrgAttachmentsList
func (tr *DrgAttachmentsList) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
