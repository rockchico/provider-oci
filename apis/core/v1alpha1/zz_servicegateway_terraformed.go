...
// GetInitParameters of this ServiceGateway
func (tr *ServiceGateway) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ServiceGateway
func (tr *ServiceGateway) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
