...
// GetInitParameters of this RouteTableAttachment
func (tr *RouteTableAttachment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RouteTableAttachment
func (tr *RouteTableAttachment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
