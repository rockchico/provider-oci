...
// GetInitParameters of this Drg
func (tr *Drg) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Drg
func (tr *Drg) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
