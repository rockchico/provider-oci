...
// GetInitParameters of this Vtap
func (tr *Vtap) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Vtap
func (tr *Vtap) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
