...
// GetInitParameters of this DHCPOptions
func (tr *DHCPOptions) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DHCPOptions
func (tr *DHCPOptions) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
