...
// GetInitParameters of this DrgAttachmentManagement
func (tr *DrgAttachmentManagement) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DrgAttachmentManagement
func (tr *DrgAttachmentManagement) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
