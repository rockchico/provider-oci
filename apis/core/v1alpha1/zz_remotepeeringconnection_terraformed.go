...
// GetInitParameters of this RemotePeeringConnection
func (tr *RemotePeeringConnection) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this RemotePeeringConnection
func (tr *RemotePeeringConnection) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
