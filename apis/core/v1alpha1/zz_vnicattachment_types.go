...
type VnicAttachmentCreateVnicDetailsIpv6AddressIpv6SubnetCidrPairDetailsInitParameters struct {
...
type VnicAttachmentInitParameters struct {
	...
	CreateVnicDetails []VnicAttachmentCreateVnicDetailsInitParameters `json:"createVnicDetails,omitempty" tf:"create_vnic_details,omitempty"`
...
type VnicAttachmentObservation struct {
	...
	// (Updatable) Contains properties for a VNIC. You use this object when creating the primary VNIC during instance launch or when creating a secondary VNIC. For more information about VNICs, see Virtual Network Interface Cards (VNICs).
	CreateVnicDetails []VnicAttachmentCreateVnicDetailsObservation `json:"createVnicDetails,omitempty" tf:"create_vnic_details,omitempty"`
...
type VnicAttachmentParameters struct {
	...
	// (Updatable) Contains properties for a VNIC. You use this object when creating the primary VNIC during instance launch or when creating a secondary VNIC. For more information about VNICs, see Virtual Network Interface Cards (VNICs).
	// +kubebuilder:validation:Optional
	CreateVnicDetails []VnicAttachmentCreateVnicDetailsParameters `json:"createVnicDetails,omitempty" tf:"create_vnic_details,omitempty"`
