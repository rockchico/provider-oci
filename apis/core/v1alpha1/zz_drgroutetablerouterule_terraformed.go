...
// GetInitParameters of this DrgRouteTableRouteRule
func (tr *DrgRouteTableRouteRule) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DrgRouteTableRouteRule
func (tr *DrgRouteTableRouteRule) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
