...
// GetInitParameters of this DrgRouteDistributionStatement
func (tr *DrgRouteDistributionStatement) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DrgRouteDistributionStatement
func (tr *DrgRouteDistributionStatement) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
