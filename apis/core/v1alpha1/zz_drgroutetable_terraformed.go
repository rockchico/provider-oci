...
// GetInitParameters of this DrgRouteTable
func (tr *DrgRouteTable) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DrgRouteTable
func (tr *DrgRouteTable) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
