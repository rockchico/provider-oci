...
// GetInitParameters of this InstanceConsoleConnection
func (tr *InstanceConsoleConnection) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this InstanceConsoleConnection
func (tr *InstanceConsoleConnection) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
