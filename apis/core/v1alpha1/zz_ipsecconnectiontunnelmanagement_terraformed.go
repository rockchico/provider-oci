...
// GetInitParameters of this IpsecConnectionTunnelManagement
func (tr *IpsecConnectionTunnelManagement) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this IpsecConnectionTunnelManagement
func (tr *IpsecConnectionTunnelManagement) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
