...
// GetInitParameters of this DedicatedVMHost
func (tr *DedicatedVMHost) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DedicatedVMHost
func (tr *DedicatedVMHost) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
