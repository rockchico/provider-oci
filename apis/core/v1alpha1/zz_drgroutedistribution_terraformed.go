...
// GetInitParameters of this DrgRouteDistribution
func (tr *DrgRouteDistribution) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DrgRouteDistribution
func (tr *DrgRouteDistribution) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
