...
// GetInitParameters of this SecurityList
func (tr *SecurityList) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SecurityList
func (tr *SecurityList) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
