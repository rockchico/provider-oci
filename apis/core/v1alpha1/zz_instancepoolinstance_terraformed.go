...
// GetInitParameters of this InstancePoolInstance
func (tr *InstancePoolInstance) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this InstancePoolInstance
func (tr *InstancePoolInstance) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
