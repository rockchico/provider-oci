...
// GetInitParameters of this PublicIPPoolCapacity
func (tr *PublicIPPoolCapacity) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this PublicIPPoolCapacity
func (tr *PublicIPPoolCapacity) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
