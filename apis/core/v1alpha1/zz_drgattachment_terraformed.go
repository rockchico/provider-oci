...
// GetInitParameters of this DrgAttachment
func (tr *DrgAttachment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DrgAttachment
func (tr *DrgAttachment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
