...
// GetInitParameters of this VolumeGroup
func (tr *VolumeGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this VolumeGroup
func (tr *VolumeGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
