...
// GetInitParameters of this UnifiedAgentConfiguration
func (tr *UnifiedAgentConfiguration) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this UnifiedAgentConfiguration
func (tr *UnifiedAgentConfiguration) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
