...
// GetInitParameters of this LogGroup
func (tr *LogGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LogGroup
func (tr *LogGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
