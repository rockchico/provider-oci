...
// GetInitParameters of this LogSavedSearch
func (tr *LogSavedSearch) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LogSavedSearch
func (tr *LogSavedSearch) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
