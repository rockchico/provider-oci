...
// GetInitParameters of this Log
func (tr *Log) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Log
func (tr *Log) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
