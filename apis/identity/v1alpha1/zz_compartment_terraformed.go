...
// GetInitParameters of this Compartment
func (tr *Compartment) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Compartment
func (tr *Compartment) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
