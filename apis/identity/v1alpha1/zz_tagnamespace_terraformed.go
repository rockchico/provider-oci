...
// GetInitParameters of this TagNamespace
func (tr *TagNamespace) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this TagNamespace
func (tr *TagNamespace) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
