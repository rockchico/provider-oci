...
func (tr *Alarm) GetObservation() (map[string]any, error) {
...
func (tr *Alarm) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this Alarm
...
func (tr *Alarm) GetParameters() (map[string]any, error) {
...
func (tr *Alarm) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Alarm
func (tr *Alarm) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Alarm
func (tr *Alarm) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Alarm using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Alarm) LateInitialize(attrs []byte) (bool, error) {
	params := &AlarmParameters{}
