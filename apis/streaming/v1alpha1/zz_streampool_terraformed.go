...
// GetInitParameters of this StreamPool
func (tr *StreamPool) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StreamPool
func (tr *StreamPool) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
