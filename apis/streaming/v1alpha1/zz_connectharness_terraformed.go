...
// GetInitParameters of this ConnectHarness
func (tr *ConnectHarness) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ConnectHarness
func (tr *ConnectHarness) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
