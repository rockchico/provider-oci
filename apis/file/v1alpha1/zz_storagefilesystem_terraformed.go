...
// GetInitParameters of this StorageFileSystem
func (tr *StorageFileSystem) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StorageFileSystem
func (tr *StorageFileSystem) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
