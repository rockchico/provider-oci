...
// GetInitParameters of this StorageExportSet
func (tr *StorageExportSet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StorageExportSet
func (tr *StorageExportSet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
