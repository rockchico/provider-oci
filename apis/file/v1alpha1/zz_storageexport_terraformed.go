...
// GetInitParameters of this StorageExport
func (tr *StorageExport) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StorageExport
func (tr *StorageExport) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
