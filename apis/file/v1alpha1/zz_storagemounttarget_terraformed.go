...
// GetInitParameters of this StorageMountTarget
func (tr *StorageMountTarget) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StorageMountTarget
func (tr *StorageMountTarget) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
