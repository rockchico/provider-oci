...
// GetInitParameters of this StorageSnapshot
func (tr *StorageSnapshot) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this StorageSnapshot
func (tr *StorageSnapshot) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
