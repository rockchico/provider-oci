...
PROJECT_REPO ?= github.com/rockchico/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 6.9.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-oci
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-null_v6.9.0
